  ...
  return (
    <div style={{ ...styles.app, alignItems: "center", justifyContent: "center", display: "flex", flexDirection: "column", padding: 24, textAlign: "center" }}>
      ...
      <div className="screen-in" style={{ ...styles.menuCover, width: "100%", maxWidth: 340, boxSizing: "border-box" }}>
        ...
        <div style={{ fontFamily: DISPLAY_FONT, fontSize: 34, lineHeight: 1.05, color: COLORS.ink, fontWeight: 700, letterSpacing: 0.2, margin: "8px 0 8px", overflowWrap: "anywhere", minWidth: 0 }}>Liberté Financière</div>
          ...
          {hasSave && (
            <div style={styles.menuSaveCard}>
              ...
              {multiplayer && activePlayer ? (
                <>
                  <div style={{ fontFamily: DISPLAY_FONT, fontSize: 15, color: COLORS.ink, fontWeight: 700, marginTop: 2 }}>{activePlayer.profession?.icon} Au tour de {activePlayer.name}</div>
                ...
                <>
                  <div style={{ fontFamily: DISPLAY_FONT, fontSize: 15, color: COLORS.ink, fontWeight: 700, marginTop: 2 }}>{profession.icon} {profession.name}</div>
