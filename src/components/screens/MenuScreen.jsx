          ...
          {hasSave && (
            <div style={styles.menuSaveCard}>
              ...
              {multiplayer && activePlayer ? (
                <>
                  <div style={{ fontFamily: FONT_DISPLAY, fontSize: 15, color: COLORS.ink, fontWeight: 700, marginTop: 2 }}>{activePlayer.profession?.icon} Au tour de {activePlayer.name}</div>
                ...
                <>
                  <div style={{ fontFamily: FONT_DISPLAY, fontSize: 15, color: COLORS.ink, fontWeight: 700, marginTop: 2 }}>{profession.icon} {profession.name}</div>
