...
export const MANUAL_SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: "p", text: "L'économie possède sa propre cadence : une journée déclenche 2 impulsions de marché, donc 2 nouvelles bougies ; 7 jours en déclenchent 14 et un mois 60. OppMarket suit exactement la même cadence : pendant un saut, des annonces expirent ou sont achetées, tandis que de nouvelles les remplacent. Le bilan du saut indique combien d'occasions ont disparu." },
  ...
  },
  {
    ...
    body: [
      ...
      { type: "p", text: "Ouvrir la fiche détaillée réserve temporairement l'annonce : son échéance est suspendue pendant votre lecture, mais la Bourse et les autres offres continuent d'évoluer. Le compteur reprend exactement à la fermeture de la fiche. Une seule annonce peut être réservée de cette façon à la fois." },
