  ...
  return (
    <div style={styles.app}>
      <div style={styles.topBar}>
        ...
        <div style={{ fontSize: 15, fontWeight: 700, color: C.ink }}>Options — Capital Life</div>
      </div>

      <div style={{ ...styles.content, padding: 16 }}>
        <div style={{ ...styles.card, padding: 20, marginBottom: 18 }}>
        ...
        <div style={{ padding: "4px 4px 20px", marginBottom: 18, borderBottom: `1px solid ${C.line}` }}>
